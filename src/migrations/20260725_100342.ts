...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_bubble_tea" ADD COLUMN "mode" "enum_pages_blocks_bubble_tea_mode" DEFAULT 'highlight';
  ALTER TABLE "pages_blocks_bubble_tea" ADD COLUMN "view_all_type" "enum_pages_blocks_bubble_tea_view_all_type" DEFAULT 'reference';
  ALTER TABLE "pages_blocks_bubble_tea" ADD COLUMN "view_all_new_tab" boolean;
  ALTER TABLE "pages_blocks_bubble_tea" ADD COLUMN "view_all_url" varchar;
  ALTER TABLE "pages_blocks_bubble_tea" ADD COLUMN "view_all_label" varchar;
  ...
  ALTER TABLE "_pages_v_blocks_bubble_tea" ADD COLUMN "mode" "enum__pages_v_blocks_bubble_tea_mode" DEFAULT 'highlight';
  ALTER TABLE "_pages_v_blocks_bubble_tea" ADD COLUMN "view_all_type" "enum__pages_v_blocks_bubble_tea_view_all_type" DEFAULT 'reference';
  ALTER TABLE "_pages_v_blocks_bubble_tea" ADD COLUMN "view_all_new_tab" boolean;
  ALTER TABLE "_pages_v_blocks_bubble_tea" ADD COLUMN "view_all_url" varchar;
  ALTER TABLE "_pages_v_blocks_bubble_tea" ADD COLUMN "view_all_label" varchar;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_bubble_tea_toppings_items" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_pages_v_blocks_contact" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_pages_v_blocks_bubble_tea_toppings_items" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "pages_blocks_bubble_tea" DROP COLUMN "mode";
  ALTER TABLE "pages_blocks_bubble_tea" DROP COLUMN "view_all_type";
  ALTER TABLE "pages_blocks_bubble_tea" DROP COLUMN "view_all_new_tab";
  ALTER TABLE "pages_blocks_bubble_tea" DROP COLUMN "view_all_url";
  ALTER TABLE "pages_blocks_bubble_tea" DROP COLUMN "view_all_label";
  ...
  ALTER TABLE "_pages_v_blocks_bubble_tea" DROP COLUMN "mode";
  ALTER TABLE "_pages_v_blocks_bubble_tea" DROP COLUMN "view_all_type";
  ALTER TABLE "_pages_v_blocks_bubble_tea" DROP COLUMN "view_all_new_tab";
  ALTER TABLE "_pages_v_blocks_bubble_tea" DROP COLUMN "view_all_url";
  ALTER TABLE "_pages_v_blocks_bubble_tea" DROP COLUMN "view_all_label";
  ...
  DROP TYPE "public"."enum_pages_blocks_bubble_tea_mode";
  DROP TYPE "public"."enum_pages_blocks_bubble_tea_view_all_type";
  DROP TYPE "public"."enum__pages_v_blocks_bubble_tea_mode";
  DROP TYPE "public"."enum__pages_v_blocks_bubble_tea_view_all_type";`)
}
